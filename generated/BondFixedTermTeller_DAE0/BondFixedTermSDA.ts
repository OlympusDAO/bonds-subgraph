...
export class DefaultsUpdated extends ethereum.Event {
  get params(): DefaultsUpdated__Params {
    return new DefaultsUpdated__Params(this);
  }
}

export class DefaultsUpdated__Params {
  _event: DefaultsUpdated;

  constructor(event: DefaultsUpdated) {
    this._event = event;
  }

  get defaultTuneInterval(): BigInt {
    return this._event.parameters[0].value.toBigInt();
  }

  get defaultTuneAdjustment(): BigInt {
    return this._event.parameters[1].value.toBigInt();
  }

  get minDebtDecayInterval(): BigInt {
    return this._event.parameters[2].value.toBigInt();
  }

  get minDepositInterval(): BigInt {
    return this._event.parameters[3].value.toBigInt();
  }

  get minMarketDuration(): BigInt {
    return this._event.parameters[4].value.toBigInt();
  }

  get minDebtBuffer(): BigInt {
...
export class BondFixedTermSDA__adjustmentsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class BondFixedTermSDA__getMarketInfoForPurchaseResult {
  value0: Address;
  value1: Address;
  value2: Address;
  value3: Address;
...
export class BondFixedTermSDA__marketsResult {
  value0: Address;
  value1: Address;
  value2: Address;
  value3: Address;
...
export class BondFixedTermSDA__metadataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class BondFixedTermSDA__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class BondFixedTermSDA extends ethereum.SmartContract {
  static bind(address: Address): BondFixedTermSDA {
    return new BondFixedTermSDA("BondFixedTermSDA", address);
  }

  adjustments(param0: BigInt): BondFixedTermSDA__adjustmentsResult {
    ...
    return new BondFixedTermSDA__adjustmentsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_adjustments(
    param0: BigInt
  ): ethereum.CallResult<BondFixedTermSDA__adjustmentsResult> {
    ...
    return ethereum.CallResult.fromValue(
      new BondFixedTermSDA__adjustmentsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
  ...
  getMarketInfoForPurchase(
    id_: BigInt
  ): BondFixedTermSDA__getMarketInfoForPurchaseResult {
    const result = super.call(
      "getMarketInfoForPurchase",
    ...
    return new BondFixedTermSDA__getMarketInfoForPurchaseResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toAddress(),
  ...
  try_getMarketInfoForPurchase(
    id_: BigInt
  ): ethereum.CallResult<BondFixedTermSDA__getMarketInfoForPurchaseResult> {
    const result = super.tryCall(
      "getMarketInfoForPurchase",
      "getMarketInfoForPurchase(uint256):(address,address,address,address,uint48,uint256)",
      [ethereum.Value.fromUnsignedBigInt(id_)]
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new BondFixedTermSDA__getMarketInfoForPurchaseResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toAddress(),
  ...
  markets(param0: BigInt): BondFixedTermSDA__marketsResult {
    const result = super.call(
      "markets",
    ...
    return new BondFixedTermSDA__marketsResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toAddress(),
  ...
  try_markets(
    param0: BigInt
  ): ethereum.CallResult<BondFixedTermSDA__marketsResult> {
    const result = super.tryCall(
      "markets",
      "markets(uint256):(address,address,address,address,bool,uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new BondFixedTermSDA__marketsResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toAddress(),
  ...
  metadata(param0: BigInt): BondFixedTermSDA__metadataResult {
    const result = super.call(
      "metadata",
    ...
    return new BondFixedTermSDA__metadataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_metadata(
    param0: BigInt
  ): ethereum.CallResult<BondFixedTermSDA__metadataResult> {
    const result = super.tryCall(
      "metadata",
      "metadata(uint256):(uint48,uint48,uint32,uint32,uint32,uint32,uint32,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new BondFixedTermSDA__metadataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  terms(param0: BigInt): BondFixedTermSDA__termsResult {
    const result = super.call(
      "terms",
    ...
    return new BondFixedTermSDA__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_terms(
    param0: BigInt
  ): ethereum.CallResult<BondFixedTermSDA__termsResult> {
    const result = super.tryCall(
      "terms",
      "terms(uint256):(uint256,uint256,uint48,uint48)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new BondFixedTermSDA__termsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
